...
public class StudentListAdapter extends BaseAdapter {
    ...
    public StudentListAdapter(Context context, List<Student> cardList) {
        this.mList = cardList;
    ...
    public View getView(int i, View view, ViewGroup group) {
        ...
        holder.classNo.setText(mList.get(i).getStuNo());
        holder.className.setText(mList.get(i).getName());
        holder.profession.setText(mList.get(i).getAge());
        holder.classPeople.setText(mList.get(i).getClassNo());
